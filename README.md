...
- Puedes cambiar el nombre del color de HSL a HEX y vicebersa ![alt text](./assets/img/image-3.png)
- Tabien puedes bloquear uno o varios colores para que no se cambien cuando generes una nueva paleta![alt text](./assets/img/image-4.png)
